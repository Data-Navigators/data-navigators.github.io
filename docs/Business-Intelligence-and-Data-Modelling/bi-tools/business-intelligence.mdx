...
## Next step: Data Modeling

BI dashboards and reports are only as reliable as the data models behind them. Continue to [Intro to Data Modeling](../data-modeling/intro-to-data-modeling) to see how structuring data well supports better BI outcomes.
