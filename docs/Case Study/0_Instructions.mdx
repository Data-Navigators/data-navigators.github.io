...
1. Produce your results in a presentable format so that you can cover your analysis in 30 mins. (Try not to spend too much time on generating slide decks, but experiment with converting code outcomes to slides.)
