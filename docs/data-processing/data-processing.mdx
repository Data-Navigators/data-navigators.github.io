...
sidebar_position: 1
---
##### *Read this and proceed* : [Link](https://www.invensis.net/blog/what-is-data-processing?)
...
> **Next:** see [A Simple Data Pipeline](./data-pipeline) for a complete, end-to-end example showing **lineage**, **data flow**, and **outcome** with concrete data and SQL at every stage.